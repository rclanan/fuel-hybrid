...
class Config extends Fuel\Core\Config
{
    ...
    public static function register_driver($driver_name, $driver_class = null)
    {
        ...
        if ( ! $driver_class === "")
        {
            $driver_class = 'model_' . $driver_name;
        }
        ...
        {
            throw new Fuel_Exception("\Hybrid\Config: Driver class {$driver_class} not found.");
            return false;
        }
    ...
    public static function unregister_driver($driver_name)
    {
        ...
        throw new Fuel_Exception("\Hybrid\Config: Driver {$driver_name} are not registered.");
        return false;
    }
